...
class TwigExtrasPlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('This is a plugin for Craft CMS that adds custom filters and functions to twig.');
    }
    ...
    {
        return 'https://github.com/drieshooghe/crafttwigextras/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/drieshooghe/crafttwigextras/master/releases.json';
    }
    ...
    {
        return 'https://github.com/drieshooghe';
    }
    ...
    {
        Craft::import('plugins.twigextras.twigextensions.TwigExtrasTwigExtension');

        return new TwigExtrasTwigExtension();
    }
